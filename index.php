...
<!-- Mirrored from ahadhossain.com/frozentheme/kint/index-particles.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Aug 2018 00:43:26 GMT -->
<head>
	<title>Mohammad Aktaa</title>
	<meta charset="UTF-8">
	<meta name="description" content="Mohammad Aktaa Portfolio">
	<meta name="keywords" content="Mohammad Aktaa, portfolio">
...
<body>
	...
	<!-- Hero section start -->
	<section class="hero-section hero-style-two set-bg" id="home" data-setbg="img/computer.jpg">
		<div id="particles"></div>
		<div class="hero-content">
			<h2>Hello, I'm Mohammad Aktaa</h2>
			<div class="typing__module">
				<div class="typed-strings" ><span>I'm a web developer</span><span> do creative</span><span>I'm a fullstack developer</span>
				</div><span class="typed" style="font-size: 20px;font-weight: 700;color: #ffffff"></span>
			</div><!-- End / typing__module -->
			<a class="fa fa-angle-down" href="#about" data-target="#about" style="cursor: pointer;"></a>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2">
					...
					<!-- contact form -->
					<form action="http://ahadhossain.com/frozentheme/kint/mail.php" method="POST" class="contact-form" id="contact-form">
						<div class="row">
							<div class="col-sm-6">
	...
	<footer class="footer-section spad set-bg" data-setbg="img/footer-bg.svg">
		<div class="container">
			...
			<!-- copyright -->
			<p class="copyright">Copyright &copy; 2018 KNIT, All rights Reserved.<br>Created by FrozenTheme</p>
		</div>
	</footer>
	<!-- Footer section end -->
...
<!-- Mirrored from ahadhossain.com/frozentheme/kint/index-particles.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Aug 2018 00:43:28 GMT -->
</html>
